 ...
 * generated in the com.zsy.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://webservice.zsy.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://webservice.zsy.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zsy.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.zsy.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.zsy.com/", name = "queryWeather")
