...
public interface ECGAdaptorSoap {
    ...
    @RequestWrapper(localName = "GetWorkList", targetNamespace = "http://tempuri.org/", className = "com.zsy.webservice.test.GetWorkList")
    @ResponseWrapper(localName = "GetWorkListResponse", targetNamespace = "http://tempuri.org/", className = "com.zsy.webservice.test.GetWorkListResponse")
    ...
    @RequestWrapper(localName = "SetSendState", targetNamespace = "http://tempuri.org/", className = "com.zsy.webservice.test.SetSendState")
    @ResponseWrapper(localName = "SetSendStateResponse", targetNamespace = "http://tempuri.org/", className = "com.zsy.webservice.test.SetSendStateResponse")
