...
public class BaoXiaoDan {
    public static void main(String[] args) {
        ...
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream(new File("D:/abc/pdf/报告模板/" + System.currentTimeMillis() + ".pdf")));
            ...
            cell11.setBorder(0);
            Image image1 = Image.getInstance("D:/abc/pdf/Image.png");
            Image image2 = Image.getInstance("D:/abc/pdf/001.png");
            //设置每列宽度比例   
            ...
            document.add(table1);
            //加入空行
            Paragraph blankRow1 = new Paragraph(18f, " 加入空行哈 ", FontChinese18);
            ...
            Image image21 = Image.getInstance("D:/abc/pdf/001.png");
            cell21.setBorder(0);
            ...
            document.add(table3);
            //加入空行
            Paragraph blankRow31 = new Paragraph(18f, "加入空行", FontChinese11);
            ...
            PdfPCell c71 = new PdfPCell(new Paragraph("费用类型", FontChinese11Bold));
            PdfPCell c72 = new PdfPCell(new Paragraph("费用发生时间", FontChinese11Bold));
            PdfPCell c73 = new PdfPCell(new Paragraph("详细信息", FontChinese11Bold));
            PdfPCell c74 = new PdfPCell(new Paragraph("消费金币/币种", FontChinese11Bold));
            PdfPCell c75 = new PdfPCell(new Paragraph("报销汇率", FontChinese11Bold));
            PdfPCell c76 = new PdfPCell(new Paragraph("报销金额", FontChinese11Bold));
            //表格高度
            c71.setFixedHeight(25);
            c72.setFixedHeight(25);
            c73.setFixedHeight(25);
            c74.setFixedHeight(25);
            c75.setFixedHeight(25);
            c76.setFixedHeight(25);
            //水平居中
            c71.setHorizontalAlignment(Element.ALIGN_CENTER);
            c72.setHorizontalAlignment(Element.ALIGN_CENTER);
            c73.setHorizontalAlignment(Element.ALIGN_CENTER);
            c74.setHorizontalAlignment(Element.ALIGN_CENTER);
            c75.setHorizontalAlignment(Element.ALIGN_CENTER);
            c76.setHorizontalAlignment(Element.ALIGN_CENTER);
            //垂直居中
            c71.setVerticalAlignment(Element.ALIGN_MIDDLE);
            c72.setVerticalAlignment(Element.ALIGN_MIDDLE);
            c73.setVerticalAlignment(Element.ALIGN_MIDDLE);
            c74.setVerticalAlignment(Element.ALIGN_MIDDLE);
            c75.setVerticalAlignment(Element.ALIGN_MIDDLE);
            c76.setVerticalAlignment(Element.ALIGN_MIDDLE);
            //边框颜色
            c71.setBorderColor(lightGrey);
            c72.setBorderColor(lightGrey);
            c73.setBorderColor(lightGrey);
            c74.setBorderColor(lightGrey);
            c75.setBorderColor(lightGrey);
            c76.setBorderColor(lightGrey);
            //去掉左右边框
            c71.disableBorderSide(8);
            c72.disableBorderSide(4);
            c72.disableBorderSide(8);
            c73.disableBorderSide(4);
            c73.disableBorderSide(8);
            c74.disableBorderSide(4);
            c74.disableBorderSide(8);
            c75.disableBorderSide(4);
            c75.disableBorderSide(8);
            c76.disableBorderSide(4);
            table7.addCell(c71);
            table7.addCell(c72);
            table7.addCell(c73);
            table7.addCell(c74);
