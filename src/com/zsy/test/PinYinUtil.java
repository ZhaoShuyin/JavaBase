...
//        System.out.println("<" + getSelling("abcdefg", true) + ">");
        System.out.println(UUID.fromString("38400000-8cf0-11bd-b23e-10b96e4ef00d").toString());;
        System.out.println(UUID.fromString("38400000-8cf0-11bd-b23e-10b96e4ef00d").toString());;
        System.out.println("=================");
        System.out.println(UUID.nameUUIDFromBytes("123".getBytes()).toString());;
        System.out.println(UUID.nameUUIDFromBytes("123".getBytes()).toString());;
        System.out.println(UUID.nameUUIDFromBytes("12".getBytes()).toString());;
        System.out.println("=================");
